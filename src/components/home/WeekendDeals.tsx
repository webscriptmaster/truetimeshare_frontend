...
export default function WeekendDeals() {
  ...
  return (
    <div className="mt-[400px] flex flex-col justify-center md:mt-[120px]">
      <h1 className="font-hg text-center text-[36px] font-bold text-[#048BC4]">
        Last Minute Weekend Deals
      </h1>

      <div className="mt-[24px] flex justify-center">
        <div className="flex w-full text-center text-[20px] font-normal text-[#4F4F4F] lg:w-5/6">
          Join our vibrant community of travel enthusiasts and discover a world
          of possibilities. Let True Timeshare LLC be your trusted companion in
